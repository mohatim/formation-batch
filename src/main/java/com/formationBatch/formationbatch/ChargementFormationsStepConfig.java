...
import com.formationBatch.formationbatch.listeners.ChargementFormationsStepListener;
import com.formationBatch.formationbatch.mappers.FormationItemPreparedStatementSetter;
...
public class ChargementFormationsStepConfig {
	...
	@Bean
	@StepScope
	public StaxEventItemReader<Formation> formationItemReader(@Value("#{jobParameters['formationsFile']}") Resource inputFile){
	...
	@Bean
	public ItemWriter<Formation> formationItemWriter(DataSource dataSource){
	...
	@Bean
	public Step chargementFormationsStep(StepBuilderFactory stepBuilderFactory) {
		return stepBuilderFactory
				.get("chargementFormationStep")
